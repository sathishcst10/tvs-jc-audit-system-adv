        ...
        jobCardInfoService.getJobCardDataById(argID).then(
            (response)=>{
                ...
                setJobCardDetails({
                    ...
                    serviceDate: response.data.data.data[0].serviceDate,
                    ...
                    customerVoice: response.data.data.data[0].customerVoice,
                    initialObservation: response.data.data.data[0].initialObservation,
                    finalFinding: response.data.data.data[0].finalFinding,
                    actionTaken: response.data.data.data[0].actionTaken,
                    dealerObservation: response.data.data.data[0].dealerObservation,
                                    ...
                                    <div>
                                        ...
                                        <div className="row">
                                            <div className="col-3">
                                                ...
                                                <div className="form-control disabled">
                                                    {
                                                        JSON.parse(customerVoice).map((items, idx)=>(
                                            ...
                                            <div className="col-3">
                                                ...
                                                <div className="form-control disabled">
                                                    {
                                                        JSON.parse(initialObservation).map((items, idx)=>(
                                                            <span className="badge bg-dark me-1 mb-1">
                                                                {items}
                                                            </span>
                                                        ))
                                            ...
                                            <div className="col-3">
                                                ...
                                                <div className="form-control disabled">
                                                    {
                                                        JSON.parse(finalFinding).map((items, idx)=>(
                                                            <span className="badge bg-dark me-1 mb-1">
                                                                {items}
                                                            </span>
                                                        ))
                                            ...
                                            <div className="col-3">
                                                ...
                                                <div className="form-control disabled">
                                                    {
                                                        JSON.parse(actionTaken).map((items, idx)=>(
                                                            <span className="badge bg-dark me-1 mb-1">
                                                                {items}
                                                            </span>
                                                        ))
                                        ...
                                        <div className="row">
                                            <div className="col-3">
                                                ...
                                                <div className="form-control disabled">
                                                    {
                                                        JSON.parse(dealerObservation).map((items, idx)=>(
                                                            <span className="badge bg-dark me-1 mb-1">
                                                                {items}
                                                            </span>
                                                        ))
                                            ...
                                            <div className="col-3">
                                                ...
                                                <div>
                                                    <button className="btn btn-sm btn-primary"> Front </button>
